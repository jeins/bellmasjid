define(['../app.common'], function(app){
        ...
        var service = function(CONFIG) {
            function des (key, message, encrypt, mode, iv, padding) {
                ...
                var m=0, i, j, temp, temp2, right1, right2, left, right, looping, result, tempresult;
            ...
            function encodeRSA(text){
                var ciphertext = des(CONFIG.key.base1, text, 1, 0);
                return stringToHex(ciphertext);
            }

            function encodeBase64(text){
                var Base64 = {
                    _keyStr: CONFIG.key.base2,
